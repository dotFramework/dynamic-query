...
{
    public class OracleAndFilterEvaluator : AndFilterEvaluator
    {
        public OracleAndFilterEvaluator(AndFilter evaluationObject) : base(evaluationObject)
        {
        }
        ...
        public override string ToString()
        {
            ...
            if (EvaluationObject.FilterList != null && EvaluationObject.FilterList.Count != 0)
            {
                ...
                {
                    strFilter += OracleFilterEvaluatorFactory.Instance.GetFilterEvaluator(EvaluationObject.FilterList[i]).ToString() + " AND ";
                }
