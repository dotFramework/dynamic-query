...
{
    public class OracleUpdateQueryEvaluator : UpdateQueryEvaluator
    {
        public OracleUpdateQueryEvaluator(UpdateQuery evaluationObject) : base(evaluationObject)
        {
        }
        ...
        protected override string GenerateQuery()
        {
            ...
            builder.AppendLine();
            builder.AppendFormat("SET {0}", new OracleUpdateFieldListEvaluator(EvaluationObject.UpdateFieldList).ToString());
